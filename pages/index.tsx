...
export default function Home() {
  ...
  return (
    <div className='h-screen flex items-center justify-center px-5'>
      <div className='bg-gray-700 h-auto w-full max-w-[500px] rounded-lg flex flex-col items-center py-8 px-5 sm:px-12 shadow-2xl relative'>
        <div className='flex flex-col items-center h-auto w-full my-2 pb-5 relative gap-3'>
          ...
          <div className='w-full border-black min-h-[110px] h-auto flex items-center justify-center'>
            {
              advice === '' ?
        ...
        <button onClick={() => getAdvice()} className='w-full flex justify-center h-auto cursor-pointer '>
